...
public class OperatorOI {
    ...
    public void configureController(){
        ...
        shootOutSlow.onTrue(new InstantCommand(()->shooter.setSpeed(-.57)))
        ...
        */
        ...
        Trigger setArmHome = new JoystickButton(controller, XboxController.Button.kY.value);
        setArmHome.onTrue(new SetArmHome());
        
        Trigger setArmHigh = new JoystickButton(controller, XboxController.Button.kA.value);
